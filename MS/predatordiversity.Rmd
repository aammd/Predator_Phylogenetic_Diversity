...
In a community, we expect a certain variation in teh amount of generalism.

in this community, the farther apart species are, the less they share in diet similaryin as measured by feeding trials.  

why? relate this to different predator groups: leeches, flies and leptagrion.  What do they normally eat?

Feeding mode is also important: Tabanids and leeches are peircing predators, while Leptagrion is gape-limited.  These effects might only be present at one stage of the life cycle.  

Was there a difference in feeding rate among the different predators?  I think so -- I think Leptagrion ate much more of their prey than did leeches.  
...
In our feeding trials, predators differ in diet breadth and feeding rate, becoming increasingly different across the phylogeny.  This is probably because of differences in species traits -- gape size, and metabolic rate (check literature).

What are the consequences of diet breatch for food webs?

Predators do not occur in all parts of the platns equally.  Why?

The study of predator negative association should probably be done via Alathea's c-score technique, now that I think of it. Can her c-score technique be rated by the metabolic capacity?  

Every null model -- recalculate my metabolic distance phylogenetic slope

Can phylogenetic diversity and metabolic distance be combined somehow?

relate feeding trails also to metabolic distance.  This would correct for different feeding trial rates AND generate a nice consistency among all parts of the paper, drawing 'metabolic capacity' along with phylogeny into the whole.
...
Metacommunity theory does not necessarying assume this degree of heterogeniety among patches in terms of the prefernce, perfoamance of predators -- not every predator is found everywhere.  Not every predator *can* eat every prey.  This variation modifies the tradtional patch-dynamic or mass-effect models of metacommunity structure.  If females are able to select suitable bromeliads for oviposition, they may have a much more complex, contigent landscape than previously thought.

### community experiment

the non-additive effect

N did not go into our leaves -- perhaps because insects are not as important in the decomposition of this community as they are in other systems, such as Costa Rica where Jackie did her work.

...
When predators do co-occur, their direct effects on each other and on their prey is determined by their diet breadth. Diet breadth (the diversity of prey species which predators consume) will depend on their feeding traits and nutritional requirements -- both of which may be phylogenetically conserved. If this is the case, then predator assemblages with higher phylogenetic diversity will show greater complementarity and a stronger top-down effect on ecosystem function
[@Finke2008a]. For
...
Indirect interactions among predators are common in many communities, which means that the total amount of top-down control cannot be predicted by summing the contributions of individual predator species [@Sih1998a]. For example, decreasing

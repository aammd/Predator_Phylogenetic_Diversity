...
increase with phylogenetic distance? We tested these questions with an
experiment involving the four most common predators, paired to maximize the
range of phylogenetic distance: two congeneric damselflies (*Leptagrion
...
leech).  Our experiment also included species in monoculture, and a predator-
free control (total of 8 treatments, n=5).  In order to control for

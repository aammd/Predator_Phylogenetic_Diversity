...
paired_predator_pianka(pred_x_resource = metabolic,pred_colname = "Taxa",... =-Taxa)
...
diet_overlap <- paired_predator_pianka(pred_x_resource = prop.eaten,pred_colname = "predator.names")

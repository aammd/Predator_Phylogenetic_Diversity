...
To quantify the effect of predators on ecosystem function, we measured five
...
invertebrate prey (emerged adults + surviving larvae). We measured the
production of FPOM by At the end of the experiment, we measured the decrease
in coarse detritus, and the increase in fine, by separating the collected
detritus on a sieve and air drying it to constant weight before weighing. We
measured uptake of labeled detrital nitrogen by analysing three innermost

...
proportion of feeding trials in which it ate a particular prey (Hypothesis 2).
...
species, as measured by the niche overlap index (Fig 1b, regression weighted by the number of prey assayed, `r F_text(diet_phylo_lm_summary)`). 

...
feeding_trials %.%
  mutate(species_pair=paste0())
# ntrials <- trials_count %.%
#   melt() %.%
#   rename(c("Var1"="ntrialpred1",
#            "Var2"="ntrialpred2",
#            "value"="ntrial")) %.%
#   filter(ntrial>0) %.%
#   mutate(species_pair=paste0(ntrialpred1,"_",ntrialpred2)) 
# 
# nrow(ntrials)
# foo <- left_join(ntrials,diet_distance)
# 

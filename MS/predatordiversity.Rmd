...
and so have additive top-down effects [@Schmitz2007]. Conversely, antagonistic
predator-predator interactions can reduce the top-down effects of a diverse
consumer assemblage, for example when predators feed directly on each other
(intra-guild predation) or modify the behaviour of predators or prey via non-
consumptive (i.e. trait-mediated) interactions
[@Sih1998a;@Griswold2006;@Nystrom2001].  While there are many mechanisms

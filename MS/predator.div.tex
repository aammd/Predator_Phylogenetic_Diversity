...
% enhance nutrient cycling \citep{Schmitz2010}.  I mean hopefully.
% Predator combinations are known to have several possible outcomes --
% predators may interfere with each other, decreasing prey mortality, or
% may compliment each other, causing an increase in prey mortality.
% Such changes in the strength of top-down control could affect both the
...
\begin{figure}
  \centering
  \includegraphics{../figures/beanplot_correlation_predator_dist.pdf}
...
\begin{figure}
  \centering
  \includegraphics{../figures/beanplot_euclid_predator_dist.pdf}

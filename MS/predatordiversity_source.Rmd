...
distances <- vegdist(foodweb.matrix,method='jaccard',diag=TRUE)
...
ggplot(dataset,aes(x=phylodistance,metadistance))+geom_point()+stat_smooth(method="lm", se=FALSE)+xlab("phylogenetic distance")+ylab("correlation between total metabolic capacity")
```

...
## reordered phylogenetic distance matrix
...
```{r TABLE_metabol~phylo,results='asis'}
pander(aov(occurance_phylo_lm),caption="")   
```


#### Table2: 
```{r TABLE:diet~PD, results='asis'}

...
\usepackage{lineno}\setcounter{secnumdepth}{-1}
\begin{document}
...
predation among diverse predator assemblages is well known. Predators may also respond to each other's presence, by

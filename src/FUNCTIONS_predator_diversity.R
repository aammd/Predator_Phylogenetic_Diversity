...
## To make comparisions between pairs of predators, we need
## a factor which indicates which two predators are being
## compared. to do that, I want to pair all the predator
## names together, say in a square matrix, and then melt it
## to obtain the paired rows:
